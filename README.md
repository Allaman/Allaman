...
- [How to not accidentally delete your data with rm](https://test.rootknecht.net/blog/rm-fails/)
- [Business Logic in Nginx](https://test.rootknecht.net/blog/logic-in-nginx/)
- [Hands-on Nomad](https://test.rootknecht.net/blog/hands-on-nomad/)
- [Patching Binaries for NixOS](https://test.rootknecht.net/blog/patching-binaries-for-nixos/)
- [NixOS as Container Host](https://test.rootknecht.net/blog/nixos-as-host/)
<!-- BLOG-POST-LIST:END -->
